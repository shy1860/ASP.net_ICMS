<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TechHome.aspx.cs" Inherits="comp2139Assignment1_CustomerPages.TechHome" %>
...
<body style="background-color:honeydew">
    ...
    <h5><strong>Getting Started</strong></h5>        
         <p>Go to <a href="TechCustomer.aspx">Customers</a> to search customer information.</p> 
         <p>Go to <a href="TechContact.aspx">Contact</a> to manage contact list.</p> 
         <p>Go to <a href="CreateIncident.aspx">Incidents </a>to create/update client incident reports.</p>
         <p>Go to <a href="ViewIncident.aspx">View Incidents </a>to search and review client incident reports.</p>    
    </div>
    </form>
     <br />
